	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1().LocalClusterAccesses().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1().LocalClusterAccesses().Watch(context.TODO(), options)
			},
		},
		&storagev1.LocalClusterAccess{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *localClusterAccessInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1.LocalClusterAccess{}, f.defaultInformer)
}
